...
function tc_intro() {
    ...
    <p><a href="https://make.wordpress.org/themes/"><?php _e( 'The WordPress Theme Review Team', 'theme-check' ); ?></a>
    </p>
	<?php
}
...
function tc_success() {
    ...
    <div class="tc-success">
        <p><?php _e( 'Now your theme has passed the basic tests you need to check it properly using the test data before you upload to the WordPress Themes Directory.', 'theme-check' ); ?></p>
        ...
        <ul>
            <li>
                <a href="https://codex.wordpress.org/Theme_Development"><?php _e( 'Theme Development', 'theme-check' ); ?></a>
            </li>
            <li>
                <a href="https://wordpress.org/support/forum/5"><?php _e( 'Themes and Templates forum', 'theme-check' ); ?></a>
            </li>
            <li>
                <a href="https://codex.wordpress.org/Theme_Unit_Test"><?php _e( 'Theme Unit Tests', 'theme-check' ); ?></a>
            </li>
        </ul>
    </div>
	<?php
...
function tc_form() {
	...
	if ( defined( 'TC_PRE' ) || defined( 'TC_POST' ) ) {
		echo ' <input name="trac" type="checkbox" /> ' . __( 'Output in Trac format.', 'theme-check' );
	}
