...
function ce_create_cookie() {
    if ( ! empty( $_POST['s_exclude'] ) ) {
	    setcookie( 'exclude_paths', base64_encode( $_POST['s_exclude'] ), time() + YEAR_IN_SECONDS * 100 );
    }
}
add_action( 'init', 'ce_create_cookie' );
